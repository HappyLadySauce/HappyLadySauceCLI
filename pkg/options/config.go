...
var HAPPLADYSAUCECLIModelEnvBindings = map[string]string{
	"model.HAPPLADYSAUCECLI_AUTH_TOKEN":           "HAPPLADYSAUCECLI_AUTH_TOKEN",
	...
	"model.HAPPLADYSAUCECLI_MAX_CONTEXT_TOKENS":   "HAPPLADYSAUCECLI_MAX_CONTEXT_TOKENS",
	"model.HAPPLADYSAUCECLI_MAX_HISTORY_MESSAGES": "HAPPLADYSAUCECLI_MAX_HISTORY_MESSAGES",
	"model.HAPPLADYSAUCECLI_TOKENIZER_MODEL":      "HAPPLADYSAUCECLI_TOKENIZER_MODEL",
}
