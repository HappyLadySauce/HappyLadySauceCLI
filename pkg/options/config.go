...
var HAPPLADYSAUCECLIEnvBindings = map[string]string{
	...
	"security.file_operation_timeout_seconds":   "HAPPLADYSAUCECLI_SECURITY_FILE_OPERATION_TIMEOUT_SECONDS",
	"security.file_max_bytes":                   "HAPPLADYSAUCECLI_SECURITY_FILE_MAX_BYTES",
	"security.file_max_line_bytes":              "HAPPLADYSAUCECLI_SECURITY_FILE_MAX_LINE_BYTES",
