...
phase=capability_policy tool_name=get_weather decision=review decision_reason=network_operation status=approved approval_scope=once
phase=capability_call tool_name=get_weather decision=review approval_scope=once output_bytes=156 elapsed_ms=420 status=success
