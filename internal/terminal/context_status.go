...
func (r *Renderer) WriteTurnStatus(status budget.TurnStatus) {
...
func (r *Renderer) WriteContextStatus(budgetBreakdown *usage.Breakdown) {
	r.WriteTurnStatus(budget.TurnStatus{Budget: budgetBreakdown})
}
